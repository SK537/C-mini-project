...
///***Function to reset scores after game is over*****
void reset(void)
{
    amount_won=0;life1=0;life2=0;life3=0;life4=0;
}
///***Function to use gotoxy function in codeblocks*****
...
///*****main game loop*****
    while(1)
    {
        ...
        while (life<2)
        {
            ...
            ///***case for *2(2 attempts must be given)****
        ...
        ///***Display correct after wrong answer is given:***
